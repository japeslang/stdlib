# Japes Standard Framework

This repository houses the Japes Standard Framework, the library code included with the compiler.
...
- `src/japes.kernel` - The kernel library upon which all other libraries are based.
- `src/japes.toolchain` - The library defining the toolchain.
